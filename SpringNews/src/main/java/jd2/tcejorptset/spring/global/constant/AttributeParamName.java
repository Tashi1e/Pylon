package jd2.tcejorptset.spring.global.constant;

final class AttributeParamName {
	
	static final String JSP_LOGIN_PARAM = "login";
	...
	static final String JSP_USER_INFO_ATTRIBUTE = "user_info";
