...
public class LoginationProcess {
	...
	private final ClassPathXmlApplicationContext context = new ClassPathXmlApplicationContext("spring-servlet.xml");
	private Map <String, Object> attributesContainer = context.getBean(AttributesContainer.class).getContainer();
